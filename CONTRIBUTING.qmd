...
Commit the changes introduced by this version snapshot before proceeding with your changes.
...
Add yourself to the authors list in the front matter of `index.ipynb`.
